...
//////////////////////////////////////////////////////////////////////////////////
  function addExpense(name,date,amount,symbol){
...
//////////////////////////////////////////////////////////////////////////////////
function mergeDuplicatePlaces(array,name,amount,symbol){
  if (array.length==0)
  {array.push(
    {
      name:name,
...
increment=(increaseBy)=>{
  ...
  let currencySymbolValue=currencySymbol.value;

  
  let amountBox=document.getElementById("amountBox");
  let currentValue=amountBox.value.split(currencySymbolValue)[0];
  amountBox.value= +currentValue+increaseBy+" "+currencySymbolValue;

}
//////////////////////////////////////////////////////////////////////////////////
deleteBySymbol=(array,SymbolDeleted,AmountDeleted)=>{
  array.forEach(
    function (object){
...
//////////////////////////////////////////////////////////////////////////////////
deleteByPlaceAndSymbol=(array,PlaceDeleted,SymbolDeleted,AmountDeleted)=>{
  array.forEach(
    function (object){
...
//////////////////////////////////////////////////////////////////////////////////
function removeItemsFromExpenseLists(idToDelete){
...
function addExpenseButton(){
  ...
  function deleteExpenseButton(event){
